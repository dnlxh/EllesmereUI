...
local ADDON_ROSTER = {
    ...
    { folder = "EllesmereUIQuestTracker",      display = "Quest Tracker",      search_name = "EllesmereUI Quest Tracker",      icon_on = ICONS_PATH .. "sidebar\\consumables-ig-on.png",     icon_off = ICONS_PATH .. "sidebar\\consumables-ig.png"     },
